    ...
    if a == 1:
        ...
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 12762335 , '3a35e7b8ed6bbcec56cd723b9410236a')
                c.start(number)
        ...
        if len(accounts) == 0:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 12762335 , '3a35e7b8ed6bbcec56cd723b9410236a')
                client.connect()
        ...
        webbrowser.open('https://t.me/noob_xd')
        clr()
        banner()
        exit()
